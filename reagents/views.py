...
def index(request):
	...
	return render_to_response('reagent_list.html', {'constructs':constructs, 'antibodies':antibodies, 'proteins':proteins, 'chemicals': chemicals, 'cells':cells, 'primers':primers}) 
