...
class Cloning(models.Model):
    ...
    primer_5prime = models.ForeignKey('reagents.Primer', blank=True, related_name='5_Primer', verbose_name="5' PCR Primer")
    ...
    primer_3prime = models.ForeignKey('reagents.Primer', blank=True, related_name='3_Primer', verbose_name="3' PCR Primer")
